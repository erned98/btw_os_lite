...
hi! clear
syntax reset
let g:colors_name = "console-airline"
set background=dark
set t_Co=256
...
hi! Search		            ctermfg = 15	ctermbg = 6	    cterm = italic
hi! IncSearch		    	ctermfg = 4	    ctermbg = 15	cterm = italic
...
hi! PmenuSel		    	ctermfg = 10	ctermbg = 0		cterm = bold
...
hi! StatusLine		    	ctermfg = 233 	ctermbg = 11
hi! StatusLineNC	    	ctermfg = 11	ctermbg = 233
...
hi! WarningMsg				ctermfg = 0		ctermbg = 11	cterm = bold
